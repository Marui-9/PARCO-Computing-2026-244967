...
{ echo "========================================================================"; echo "PIPELINED MPI BENCHMARK LOG (6 NODES)"; echo "========================================================================"; echo "Started: $(date)"; echo "========================================================================"; echo ""; } > "$OUT_LOG"
trap 'echo "Interrupted at $(date)" >> "$OUT_LOG"' INT TERM
echo "Starting Pipelined MPI Benchmark (6 NODES)"
