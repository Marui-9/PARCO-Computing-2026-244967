...
TEST_MATRICES=(
    "36k_0p17.mtx" "98k_0p52.mtx" "262k_0p0011.mtx" "265k_0p0006.mtx"
    "326k_0p0030.mtx" "524k_0p0006.mtx" "916k_0p0006.mtx"
    "1438k_0p0016.mtx" "1508k_0p0012.mtx" "1585k_0p0002.mtx"
)
...
{ echo "========================================================================"; echo "PIPELINED MPI BENCHMARK LOG (2 NODES)"; echo "========================================================================"; echo "Started: $(date)"; echo "Executable: $EXE"; echo "Iterations: $ITERATIONS"; echo "========================================================================"; echo ""; } > "$OUT_LOG"
trap 'echo "Interrupted at $(date)" >> "$OUT_LOG"' INT TERM

echo "Starting Pipelined MPI Benchmark (2 NODES)"
...
echo ""; echo "======================================================================"; echo "COMPLETED: $total_runs runs | Failed: $failed_runs | Timeout: $timeout_runs"; echo "======================================================================"
{ echo "======================================================================"; echo "COMPLETED at $(date)"; echo "Total: $total_runs | Failed: $failed_runs | Timeout: $timeout_runs"; } >> "$OUT_LOG"
exit 0
